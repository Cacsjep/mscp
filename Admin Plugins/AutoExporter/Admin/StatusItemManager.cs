...
{
    public class StatusItemManager : ItemManager
    {
        private StatusUserControl _userControl;
        private readonly Guid _kind;

        public StatusItemManager(Guid kind) { _kind = kind; }
        ...
        {
            _userControl = new StatusUserControl();
            return _userControl;
        }
        ...
        public override string GetItemName() => "Status";
        public override void SetItemName(string name) { if (CurrentItem != null) CurrentItem.Name = "Status"; }
        ...
        public override Item CreateItem(Item parentItem, FQID suggestedFQID)
        {
            var fqid = new FQID(
                ...
                AutoExporterDefinition.StatusSingletonId,
                FolderType.No,
                _kind);

            CurrentItem = new Item(fqid, "Status");
        ...
        public override string GetItemStatusDetails(Item item, string language) => "Storage status across jobs";
    }
}
