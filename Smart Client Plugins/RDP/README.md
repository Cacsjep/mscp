...
Download `MSCPlugins-vX.X-Setup.msi` from [Releases](https://github.com/Cacsjep/mscp/releases) and run as **Administrator**. Select **RDP Plugin** in the feature list.
